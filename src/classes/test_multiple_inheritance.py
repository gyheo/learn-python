...
def test_multiple_inheritance():
    ...
    class CalendarClock(Country, Clock, Calendar):
    ...
    assert calendar_clock.get_date() == '01/20/2024'
    assert calendar_clock.get_time() == '01:14 PM'
    assert calendar_clock.get_country() == 'Korea'
